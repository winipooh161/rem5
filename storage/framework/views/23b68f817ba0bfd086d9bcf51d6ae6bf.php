                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-10 col-xl-8 mx-auto">
                            <h3 class="display-6 mb-4"><?php echo e(__('Вход')); ?></h3>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <label for="code" class="form-label"><?php echo e(__('Код из SMS')); ?></label>
                            <div class="code-container">
                                ...
                                <div class="resend-container text-center">
                                    <button type="button" class="btn btn-outline-secondary" id="resendCode" disabled>
                                        <?php echo e(__('Отправить повторно')); ?> <span id="timer" class="ms-1">(60)</span>
                                    </button>
                                </div>
                            </div>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    async function requestCode() {
        ...
        try {
            ...
            const response = await fetch("<?php echo e(route('login.send-code')); ?>", {
                method: 'POST',
                headers: {
            ...
            requestCodeBtn.textContent = '<?php echo e(__('Получить код')); ?>';
        }
    }
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\remont\resources\views\auth\login.blade.php ENDPATH**/ ?>