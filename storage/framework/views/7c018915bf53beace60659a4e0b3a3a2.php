                            ...
                            <div class="col-md-8">
                                <div class="d-flex flex-wrap">
                                    <div class="input-group input-group-sm me-2 mb-2" style="max-width: 200px;">
                                        ...
                                        <input type="date" class="form-control" id="date-from" value="<?php echo e(date('Y-m-d')); ?>">
                                    </div>
                                    <div class="input-group input-group-sm me-2 mb-2" style="max-width: 200px;">
                                        <span class="input-group-text">По</span>
                                        <input type="date" class="form-control" id="date-to" value="<?php echo e(date('Y-m-d', strtotime('+30 days'))); ?>">
                                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    try {
        ...
        document.getElementById('download-schedule').addEventListener('click', function(e) {
            ...
            workbook.xlsx.writeBuffer().then(buffer => {
                const blob = new Blob([buffer], { type: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet' });
                saveAs(blob, `План-график_<?php echo e($project->id); ?>_${new Date().toLocaleDateString()}.xlsx`);
            });
        });
