    ...
    <?php endif; ?>    <div class="row justify-content-center">
        ...
        <div class="col-lg-8 col-xl-6">
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('partner.estimates.store')); ?>" method="POST" id="estimateForm">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="project-search-select <?php $__errorArgs = ['project_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="project_id" name="project_id" style="width: 100%;" data-placeholder="Выберите объект">
                                <option value=""></option>
...
unset($__errorArgs, $__bag); ?>" id="type" name="type" required>
                                <option value="main" <?php echo e(old('type', 'main') == 'main' ? 'selected' : ''); ?>>Основная смета (Работы)</option>
                                <option value="additional" <?php echo e(old('type') == 'additional' ? 'selected' : ''); ?>>Дополнительная смета</option>
                                <option value="materials" <?php echo e(old('type') == 'materials' ? 'selected' : ''); ?>>Смета по материалам</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>" id="status" name="status">
                                <option value="draft" <?php echo e(old('status', 'draft') == 'draft' ? 'selected' : ''); ?>>Черновик</option>
                                <option value="pending" <?php echo e(old('status') == 'pending' ? 'selected' : ''); ?>>На рассмотрении</option>
                                <option value="approved" <?php echo e(old('status') == 'approved' ? 'selected' : ''); ?>>Утверждена</option>
                            </select>
...
<script src="<?php echo e(asset('js/estimates/excel-formula-manager.js')); ?>"></script>
...
<script src="<?php echo e(asset('js/estimates/create-enhancements.js')); ?>"></script>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\remont\resources\views/partner/estimates/create.blade.php ENDPATH**/ ?>