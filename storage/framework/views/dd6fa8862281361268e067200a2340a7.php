...
<div class="container-fluid">
    <div class="card">
        ...
        <div class="card-body">
            <form action="<?php echo e(route('partner.projects.store')); ?>" method="POST" id="createProjectForm">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="client_name" name="client_name" value="<?php echo e(old('client_name')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="object_type" name="object_type" required>
                                        <option value="">Выберите тип объекта</option>
                                        <option value="apartment" <?php echo e(old('object_type') == 'apartment' ? 'selected' : ''); ?>>Квартира</option>
                                        <option value="house" <?php echo e(old('object_type') == 'house' ? 'selected' : ''); ?>>Дом</option>
                                        <option value="office" <?php echo e(old('object_type') == 'office' ? 'selected' : ''); ?>>Офис</option>
                                        <option value="commercial" <?php echo e(old('object_type') == 'commercial' ? 'selected' : ''); ?>>Коммерческое помещение</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>" id="work_type" name="work_type" required>
                                        ...
                                        <option value="repair" <?php echo e(old('work_type') == 'repair' ? 'selected' : ''); ?>>Ремонт</option>
                                        <option value="design" <?php echo e(old('work_type') == 'design' ? 'selected' : ''); ?>>Дизайн</option>
                                        <option value="construction" <?php echo e(old('work_type') == 'construction' ? 'selected' : ''); ?>>Строительство</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>" id="status" name="status" required>
                                        <option value="new" <?php echo e(old('status', 'new') == 'new' ? 'selected' : ''); ?>>Новый</option>
                                        <option value="in_progress" <?php echo e(old('status') == 'in_progress' ? 'selected' : ''); ?>>В работе</option>
                                        <option value="on_hold" <?php echo e(old('status') == 'on_hold' ? 'selected' : ''); ?>>Приостановлен</option>
                                        <option value="completed" <?php echo e(old('status') == 'completed' ? 'selected' : ''); ?>>Завершен</option>
                                        <option value="cancelled" <?php echo e(old('status') == 'cancelled' ? 'selected' : ''); ?>>Отменен</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>" id="passport_series" name="passport_series" value="<?php echo e(old('passport_series')); ?>" placeholder="1234">
...
unset($__errorArgs, $__bag); ?>" id="passport_number" name="passport_number" value="<?php echo e(old('passport_number')); ?>" placeholder="567890">
...
unset($__errorArgs, $__bag); ?>" id="passport_issued_by" name="passport_issued_by" rows="2" placeholder="Отделом УФМС России по ..."><?php echo e(old('passport_issued_by')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="passport_issued_date" name="passport_issued_date" value="<?php echo e(old('passport_issued_date')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="passport_code" name="passport_code" value="<?php echo e(old('passport_code')); ?>" placeholder="123-456">
...
unset($__errorArgs, $__bag); ?>" id="client_birth_date" name="client_birth_date" value="<?php echo e(old('client_birth_date')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="client_birth_place" name="client_birth_place" value="<?php echo e(old('client_birth_place')); ?>" placeholder="г. Москва">
...
unset($__errorArgs, $__bag); ?>" id="client_email" name="client_email" value="<?php echo e(old('client_email')); ?>" placeholder="client@example.com">
...
unset($__errorArgs, $__bag); ?>" id="registration_postal_code" name="registration_postal_code" value="<?php echo e(old('registration_postal_code')); ?>" placeholder="123456">
...
unset($__errorArgs, $__bag); ?>" id="registration_city" name="registration_city" value="<?php echo e(old('registration_city')); ?>" placeholder="Москва">
...
unset($__errorArgs, $__bag); ?>" id="registration_street" name="registration_street" value="<?php echo e(old('registration_street')); ?>" placeholder="ул. Тверская">
...
unset($__errorArgs, $__bag); ?>" id="registration_house" name="registration_house" value="<?php echo e(old('registration_house')); ?>" placeholder="12">
...
unset($__errorArgs, $__bag); ?>" id="registration_apartment" name="registration_apartment" value="<?php echo e(old('registration_apartment')); ?>" placeholder="45">
...
unset($__errorArgs, $__bag); ?>" id="city" name="city" value="<?php echo e(old('city')); ?>" placeholder="Москва">
...
unset($__errorArgs, $__bag); ?>" id="street" name="street" value="<?php echo e(old('street')); ?>" placeholder="ул. Тверская">
...
unset($__errorArgs, $__bag); ?>" id="house_number" name="house_number" value="<?php echo e(old('house_number')); ?>" placeholder="12">
...
unset($__errorArgs, $__bag); ?>" id="entrance" name="entrance" value="<?php echo e(old('entrance')); ?>" placeholder="2">
...
unset($__errorArgs, $__bag); ?>" id="apartment_number" name="apartment_number" value="<?php echo e(old('apartment_number')); ?>" placeholder="45">
...
unset($__errorArgs, $__bag); ?>" id="area" name="area" value="<?php echo e(old('area')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="camera_link" name="camera_link" value="<?php echo e(old('camera_link')); ?>" placeholder="https://...">
...
unset($__errorArgs, $__bag); ?>" id="contact_phones" name="contact_phones" rows="3" placeholder="Укажите дополнительные номера телефонов клиента или его представителей"><?php echo e(old('contact_phones')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="work_amount" name="work_amount" value="<?php echo e(old('work_amount')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="materials_amount" name="materials_amount" value="<?php echo e(old('materials_amount')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="description" name="description" rows="4" placeholder="Дополнительная информация о проекте, особые требования клиента, заметки..."><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="estimator_id" name="estimator_id">
                                        ...
                                        <?php $__currentLoopData = $estimators; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $estimator): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($estimator->id); ?>" <?php echo e(old('estimator_id') == $estimator->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" id="contract_date" name="contract_date" value="<?php echo e(old('contract_date')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="work_start_date" name="work_start_date" value="<?php echo e(old('work_start_date')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="work_end_date" name="work_end_date" value="<?php echo e(old('work_end_date')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="contract_number" name="contract_number" value="<?php echo e(old('contract_number')); ?>">
                ...
                <div class="row mt-4">
                    <div class="col-12">
                        <div class="d-flex justify-content-between">
                            <button type="button" class="btn btn-outline-secondary" onclick="window.location.href='<?php echo e(route('partner.projects.index')); ?>'">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\remont\resources\views\partner\projects\create.blade.php ENDPATH**/ ?>