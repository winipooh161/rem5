                        ...
                        <div class="row align-items-end">
                            <div class="col-md-4 col-12 mb-md-0 mb-2">
                                ...
                                <select name="calculations[0][material_id]" class="form-select material-select" required>
                                    ...
                                    <?php $__currentLoopData = $materials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $material): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($id); ?>"><?php echo e($material['name']); ?></option>
...
function initializeCalculator() {
    let materialIndex = 0;
    const materialsData = <?php echo json_encode($materials, 15, 512) ?>;
    ...
    window.savePrices = function() {
        ...
        fetch('<?php echo e(route("partner.calculator.save-prices")); ?>', {
            method: 'POST',
            headers: {
    ...
    window.resetSinglePrice = function(materialId) {
        ...
        if (input) {
            ...
            fetch('<?php echo e(route("partner.calculator.get-prices")); ?>', {
                method: 'GET',
                headers: {
                    'X-Requested-With': 'XMLHttpRequest'
                }
    ...
    function calculateMaterials() {
        ...
        fetch('<?php echo e(route("partner.calculator.calculate")); ?>', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-Requested-With': 'XMLHttpRequest'
    ...
    document.getElementById('export-pdf').addEventListener('click', function() {
        ...
        exportForm.action = '<?php echo e(route("partner.calculator.export-pdf")); ?>';
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\remont\resources\views/partner/calculator/index.blade.php ENDPATH**/ ?>