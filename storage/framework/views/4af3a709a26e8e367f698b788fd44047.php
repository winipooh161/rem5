...
function fetchSavedPrices() {
    fetch('<?php echo e(route("estimator.calculator.get-prices")); ?>', {
        method: 'GET',
        headers: {
...
function initializeCalculator() {
    ...
    function saveServerPrices(prices) {
        fetch('<?php echo e(route("estimator.calculator.save-prices")); ?>', {
            method: 'POST',
            headers: {
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
                'Content-Type': 'application/json',
    ...
    document.getElementById('calculate-btn').addEventListener('click', function(e) {
        ...
        fetch('<?php echo e(route("estimator.calculator.calculate")); ?>', {
            method: 'POST',
            headers: {
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
                'Content-Type': 'application/json',
    ...
    document.getElementById('export-pdf-btn').addEventListener('click', function() {
        ...
        exportForm.action = '<?php echo e(route("estimator.calculator.export-pdf")); ?>';
        exportForm.submit();
    });
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\remont\resources\views\estimator\calculator\index.blade.php ENDPATH**/ ?>