...
<div class="container-fluid">
    ...
    <?php else: ?>
        ...
        <div id="pagination-data" class="d-none" 
             data-current-page="<?php echo e($projects->currentPage()); ?>" 
             data-last-page="<?php echo e($projects->lastPage()); ?>" 
             data-has-more-pages="<?php echo e($projects->hasMorePages() ? 'true' : 'false'); ?>">
        </div>
