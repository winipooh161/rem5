                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="document-actions">
                                        ...
                                        <?php endif; ?>                                        <a href="<?php echo e(route('client.project-files.download', $file->id)); ?>" class="btn btn-sm btn-outline-primary" title="Скачать">
...
<?php /**PATH C:\OSPanel\domains\remont\resources\views/client/projects/tabs/documents.blade.php ENDPATH**/ ?>