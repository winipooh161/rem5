                ...
                <div class="col-md-6">
                    <div class="d-flex flex-wrap align-items-center mb-3">
                        <div class="input-group input-group-sm me-2 mb-2" style="max-width: 200px;">
                            ...
                            <input type="date" class="form-control" id="calendar-date-from" value="<?php echo e(date('Y-m-01')); ?>">
                        </div>
                        <div class="input-group input-group-sm me-2 mb-2" style="max-width: 200px;">
                            <span class="input-group-text">По</span>
                            <input type="date" class="form-control" id="calendar-date-to" value="<?php echo e(date('Y-m-t')); ?>">
                        </div>
...
<script>
    ...
    const calendarApiUrl = '/client/projects/<?php echo e($project->id); ?>/calendar-view';
</script>
...
<?php /**PATH C:\OSPanel\domains\remont\resources\views\client\projects\tabs\calendar.blade.php ENDPATH**/ ?>