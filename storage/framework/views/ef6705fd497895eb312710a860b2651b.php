...
<?php $__env->startSection('title', 'Календарный график проекта'); ?>

<?php $__env->startSection('content'); ?>
<div class="container-fluid py-4">
    <div class="mb-4 d-flex justify-content-between align-items-center">
        <h3>Календарный график проекта #<?php echo e($project->id); ?></h3>
        <div>
            <a href="<?php echo e(route('partner.projects.show', ['project' => $project->id, 'tab' => 'schedule'])); ?>" class="btn btn-outline-secondary">
                ...
                <div class="col-md-6">
                    <div class="d-flex flex-wrap align-items-center mb-3">
                        <div class="input-group input-group-sm me-2 mb-2" style="max-width: 200px;">
                            ...
                            <input type="date" class="form-control" id="calendar-date-from" value="<?php echo e($startDate ?? date('Y-m-01')); ?>">
                        </div>
                        <div class="input-group input-group-sm me-2 mb-2" style="max-width: 200px;">
                            <span class="input-group-text">По</span>
                            <input type="date" class="form-control" id="calendar-date-to" value="<?php echo e($endDate ?? date('Y-m-t')); ?>">
                        </div>
                        ...
                        <div class="me-2 mb-2">
                            <select class="form-select form-select-sm" id="month-quick-select">
                                ...
                                <?php for($i = 0; $i < 12; $i++): ?>
                                    ...
                                    ?>
                                    <option value="<?php echo e($monthYear); ?>"><?php echo e($monthName); ?></option>
                                <?php endfor; ?>
                            </select>
                        </div>
                        <div class="me-2 mb-2">
...
<script>
    ...
    const calendarApiUrl = '<?php echo e(route('partner.projects.calendar-view', ['project' => $project->id])); ?>';
</script>
<script src="<?php echo e(asset('js/calendar-view.js')); ?>"></script>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\remont\resources\views\partner\projects\tabs\calendar.blade.php ENDPATH**/ ?>