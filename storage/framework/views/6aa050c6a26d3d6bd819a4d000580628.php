        ...
        <div class="d-flex flex-column flex-md-row align-items-start align-items-md-center justify-content-between">
            <div>
                <h1 class="h3 mb-2 mb-md-0">
                    <?php echo e($project->client_name); ?>: <?php echo e(Str::limit($project->address, 30)); ?><?php echo e($project->apartment_number ? ', кв. ' . $project->apartment_number : ''); ?>

                </h1>
                <div class="d-flex align-items-center flex-wrap mt-2">
                    <span class="badge <?php echo e($project->status == 'active' ? 'bg-success' : ($project->status == 'paused' ? 'bg-warning text-dark' : ($project->status == 'completed' ? 'bg-info' : 'bg-secondary'))); ?> me-2">
                        <?php echo e($project->status == 'active' ? 'Активен' : ($project->status == 'paused' ? 'Приостановлен' : ($project->status == 'completed' ? 'Завершен' : 'Отменен'))); ?>

                    </span>
                    <span class="text-muted small"><?php echo e($project->work_type_text); ?></span>
                </div>
            </div>
    ...
    <div class="card mb-4 project-tabs-card">
        <div class="card-header p-0 position-relative">
            <div class="nav-tabs-wrapper">
                ...
                <ul class="nav nav-tabs" id="projectTabs" data-project-id="<?php echo e($project->id); ?>" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link <?php echo e(request('tab') == 'camera' ? 'active' : ''); ?>" id="camera-tab" data-bs-toggle="tab" data-bs-target="#camera" type="button" role="tab" aria-controls="camera" aria-selected="<?php echo e(request('tab') == 'camera' ? 'true' : 'false'); ?>">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link <?php echo e(request('tab') == 'documentation' ? 'active' : ''); ?>" id="documentation-tab" data-bs-toggle="tab" data-bs-target="#documentation" type="button" role="tab" aria-controls="documentation" aria-selected="<?php echo e(request('tab') == 'documentation' ? 'true' : 'false'); ?>">
        ...
        <div class="card-body">
            <div class="tab-content" id="projectTabsContent">
                ...
                </div>                <div class="tab-pane fade <?php echo e(request('tab') == 'schedule' ? 'show active' : ''); ?>" id="schedule" role="tabpanel" aria-labelledby="schedule-tab">
                    <?php echo $__env->make('client.projects.tabs.schedule', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>

                <div class="tab-pane fade <?php echo e(request('tab') == 'camera' ? 'show active' : ''); ?>" id="camera" role="tabpanel" aria-labelledby="camera-tab">
                    <?php echo $__env->make('client.projects.tabs.camera', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                ...
                <div class="tab-pane fade <?php echo e(request('tab') == 'documentation' ? 'show active' : ''); ?>" id="documentation" role="tabpanel" aria-labelledby="documentation-tab">
                    <?php echo $__env->make('client.projects.tabs.documentation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
